...
class TranslationsMiniTranslatorResultEn {
	...
	String get no_result => 'No engine returned a result — check your network or try another engine.';
...
class TranslationsSettingsServicesEditorEn {
	...
	String get coming_soon_description => 'Service configuration is not yet available. You can manage service providers from the providers tab.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'mini_translator.result.compare_engines' => ({required Object count}) => 'Compare ${count} engines',
			...
			'mini_translator.result.no_result' => 'No engine returned a result — check your network or try another engine.',
			...
			'settings.services.editor.coming_soon_description' => 'Service configuration is not yet available. You can manage service providers from the providers tab.',
