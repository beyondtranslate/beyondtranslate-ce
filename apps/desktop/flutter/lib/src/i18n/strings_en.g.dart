...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsMiniTranslatorEn mini_translator = TranslationsMiniTranslatorEn.internal(_root);
	late final TranslationsWorkbenchEn workbench = TranslationsWorkbenchEn.internal(_root);
...
class TranslationsCommonEn {
	...
	late final TranslationsCommonLanguageEn language = TranslationsCommonLanguageEn.internal(_root);
	late final TranslationsCommonThemeModeEn theme_mode = TranslationsCommonThemeModeEn.internal(_root);
	late final TranslationsCommonThemeStyleEn theme_style = TranslationsCommonThemeStyleEn.internal(_root);
	late final TranslationsCommonProviderEn provider = TranslationsCommonProviderEn.internal(_root);
	late final TranslationsCommonWordPronunciationEn word_pronunciation = TranslationsCommonWordPronunciationEn.internal(_root);
}
...
class TranslationsMiniTranslatorEn {
	...
	// Translations
	late final TranslationsMiniTranslatorLimitedBannerEn limited_banner = TranslationsMiniTranslatorLimitedBannerEn.internal(_root);
	late final TranslationsMiniTranslatorInputEn input = TranslationsMiniTranslatorInputEn.internal(_root);
	late final TranslationsMiniTranslatorToolbarEn toolbar = TranslationsMiniTranslatorToolbarEn.internal(_root);
	late final TranslationsMiniTranslatorButtonEn button = TranslationsMiniTranslatorButtonEn.internal(_root);
	late final TranslationsMiniTranslatorLanguageEn language = TranslationsMiniTranslatorLanguageEn.internal(_root);
	late final TranslationsMiniTranslatorMessageEn message = TranslationsMiniTranslatorMessageEn.internal(_root);
	late final TranslationsMiniTranslatorResultEn result = TranslationsMiniTranslatorResultEn.internal(_root);
}
...
class TranslationsSettingsEn {
	...
	late final TranslationsSettingsServicesEn services = TranslationsSettingsServicesEn.internal(_root);
	late final TranslationsSettingsProvidersEn providers = TranslationsSettingsProvidersEn.internal(_root);
	late final TranslationsSettingsLayoutEn layout = TranslationsSettingsLayoutEn.internal(_root);
...
class TranslationsCommonUiEn {
	...
	// Translations
	late final TranslationsCommonUiButtonEn button = TranslationsCommonUiButtonEn.internal(_root);
	late final TranslationsCommonUiFeedbackEn feedback = TranslationsCommonUiFeedbackEn.internal(_root);
}
...
class TranslationsAppTrayEn {
	...
	// Translations
	late final TranslationsAppTrayContextMenuEn context_menu = TranslationsAppTrayContextMenuEn.internal(_root);
}
...
class TranslationsMiniTranslatorLimitedBannerEn {
	...
	// Translations
	late final TranslationsMiniTranslatorLimitedBannerPermissionEn permission = TranslationsMiniTranslatorLimitedBannerPermissionEn.internal(_root);
	late final TranslationsMiniTranslatorLimitedBannerInstructionEn instruction = TranslationsMiniTranslatorLimitedBannerInstructionEn.internal(_root);
	late final TranslationsMiniTranslatorLimitedBannerActionEn action = TranslationsMiniTranslatorLimitedBannerActionEn.internal(_root);
	late final TranslationsMiniTranslatorLimitedBannerFeedbackEn feedback = TranslationsMiniTranslatorLimitedBannerFeedbackEn.internal(_root);
	late final TranslationsMiniTranslatorLimitedBannerTooltipEn tooltip = TranslationsMiniTranslatorLimitedBannerTooltipEn.internal(_root);
}
...
class TranslationsMiniTranslatorInputEn {
	...
	String hint_translate_to({required Object language}) => 'Type a word or text to translate into ${language}';
}
...
class TranslationsMiniTranslatorToolbarEn {
	...
	// Translations
	late final TranslationsMiniTranslatorToolbarTooltipEn tooltip = TranslationsMiniTranslatorToolbarTooltipEn.internal(_root);
	late final TranslationsMiniTranslatorToolbarMenuEn menu = TranslationsMiniTranslatorToolbarMenuEn.internal(_root);
}
...
class TranslationsMiniTranslatorMessageEn {
	...
	String get please_enter_word_or_text => 'No text entered or text not extracted';

	/// en: 'Capture screen area has been canceled'
	String get capture_screen_area_canceled => 'Capture screen area has been canceled';

	/// en: 'No default text recognition service configured. Please set one in Settings.'
	String get ocr_service_not_configured => 'No default text recognition service configured. Please set one in Settings.';
...
class TranslationsMiniTranslatorResultEn {
	...
	String compare_services({required Object count}) => 'Compare ${count} services';
	...
	String get no_result => 'No service returned a result — check your network or try another service.';

	/// en: 'Your text is kept; retrying will not duplicate history.'
	String get no_result_note => 'Your text is kept; retrying will not duplicate history.';
}
...
class TranslationsWorkbenchPlaceholderEn {
	...
	String get history => 'Favorites and history will be available in a future release';
...
class TranslationsWorkbenchGlossaryPageEn {
	...
	String get empty_description => 'Glossary terms outrank any service output. Add them one at a time, or drop in a CSV to merge.';
	...
	String get no_books_description => 'A glossary keeps your chosen wording consistent across every service. Create one, then start adding terms.';
...
class TranslationsWorkbenchTranslationEn {
	...
	String get failed => 'Translation failed. Check the service configuration and try again.';
...
class TranslationsSettingsGeneralEn {
	...
	late final TranslationsSettingsGeneralSectionEn section = TranslationsSettingsGeneralSectionEn.internal(_root);
	late final TranslationsSettingsGeneralRowEn row = TranslationsSettingsGeneralRowEn.internal(_root);
	late final TranslationsSettingsGeneralButtonEn button = TranslationsSettingsGeneralButtonEn.internal(_root);
	late final TranslationsSettingsGeneralOptionEn option = TranslationsSettingsGeneralOptionEn.internal(_root);
	late final TranslationsSettingsGeneralEditorEn editor = TranslationsSettingsGeneralEditorEn.internal(_root);
}
...
class TranslationsSettingsAppearanceEn {
	...
	late final TranslationsSettingsAppearanceSectionEn section = TranslationsSettingsAppearanceSectionEn.internal(_root);
...
class TranslationsSettingsShortcutsEn {
	...
	late final TranslationsSettingsShortcutsSectionEn section = TranslationsSettingsShortcutsSectionEn.internal(_root);
	late final TranslationsSettingsShortcutsRowEn row = TranslationsSettingsShortcutsRowEn.internal(_root);
	late final TranslationsSettingsShortcutsResetDialogEn reset_dialog = TranslationsSettingsShortcutsResetDialogEn.internal(_root);
	late final TranslationsSettingsShortcutsGroupEn group = TranslationsSettingsShortcutsGroupEn.internal(_root);
...
class TranslationsSettingsAdvancedEn {
	...
	String get api_server_description => 'Expose the translation API on 127.0.0.1 for local integrations.';
...
class TranslationsSettingsServicesEn {
	...
	late final TranslationsSettingsServicesButtonEn button = TranslationsSettingsServicesButtonEn.internal(_root);
	late final TranslationsSettingsServicesSectionEn section = TranslationsSettingsServicesSectionEn.internal(_root);
	late final TranslationsSettingsServicesEditorEn editor = TranslationsSettingsServicesEditorEn.internal(_root);
	late final TranslationsSettingsServicesDetailEn detail = TranslationsSettingsServicesDetailEn.internal(_root);

	/// en: 'Make Default'
	String get make_default => 'Make Default';

	late final TranslationsSettingsServicesItemEn item = TranslationsSettingsServicesItemEn.internal(_root);
}
...
class TranslationsSettingsProvidersEn {
	...
	late final TranslationsSettingsProvidersSectionEn section = TranslationsSettingsProvidersSectionEn.internal(_root);
	late final TranslationsSettingsProvidersItemEn item = TranslationsSettingsProvidersItemEn.internal(_root);
	late final TranslationsSettingsProvidersButtonEn button = TranslationsSettingsProvidersButtonEn.internal(_root);
	late final TranslationsSettingsProvidersAlertEn alert = TranslationsSettingsProvidersAlertEn.internal(_root);
	late final TranslationsSettingsProvidersIntroEn intro = TranslationsSettingsProvidersIntroEn.internal(_root);
	late final TranslationsSettingsProvidersEditorEn editor = TranslationsSettingsProvidersEditorEn.internal(_root);
	late final TranslationsSettingsProvidersDetailEn detail = TranslationsSettingsProvidersDetailEn.internal(_root);
	late final TranslationsSettingsProvidersCapabilityEn capability = TranslationsSettingsProvidersCapabilityEn.internal(_root);
	late final TranslationsSettingsProvidersDescriptionEn description = TranslationsSettingsProvidersDescriptionEn.internal(_root);
	late final TranslationsSettingsProvidersDeleteDialogEn delete_dialog = TranslationsSettingsProvidersDeleteDialogEn.internal(_root);
}
...
class TranslationsAppTrayContextMenuEn {
	...
	late final TranslationsAppTrayContextMenuDevToolsEn dev_tools = TranslationsAppTrayContextMenuDevToolsEn.internal(_root);
...
class TranslationsMiniTranslatorLimitedBannerPermissionEn {
	...
	String get missing_both => 'Grant Screen Recording and Accessibility permissions to enable all features.';

	/// en: 'Grant Screen Recording permission to enable all features.'
	String get missing_screen_capture => 'Grant Screen Recording permission to enable all features.';

	/// en: 'Grant Accessibility permission to enable all features.'
	String get missing_accessibility => 'Grant Accessibility permission to enable all features.';
}
...
class TranslationsMiniTranslatorLimitedBannerFeedbackEn {
	...
	String get still_missing => 'Required permissions are still missing.\nPlease check your settings and try again.';
}
...
class TranslationsMiniTranslatorToolbarTooltipEn {
	...
	String get extract_text_from_screen_capture => 'Capture screen area and recognize text';
...
class TranslationsSettingsGeneralRowEn {
	...
	String get translation_target_hint => 'Configure language pairs used by the translator.';

	/// en: 'Common Languages'
	String get common_languages => 'Common Languages';

	/// en: 'Shown at the top of language pickers.'
	String get common_languages_description => 'Shown at the top of language pickers.';
	...
	String get double_click_copy_result => 'Double click to copy translation result';

	/// en: 'Reset to Defaults'
	String get common_languages_reset => 'Reset to Defaults';

	/// en: 'Reset to the default set of common languages'
	String get common_languages_reset_help => 'Reset to the default set of common languages';
	...
	String get screen_capture_access_hint => 'Capturing text from the screen needs to read screen contents.';

	/// en: 'Capturing selected text needs to read selections in other apps.'
	String get screen_selection_access_hint => 'Capturing selected text needs to read selections in other apps.';

	/// en: 'No translation targets yet — add one to set the default language to translate into.'
	String get no_translation_targets => 'No translation targets yet — add one to set the default language to translate into.';
}
...
class TranslationsSettingsGeneralEditorEn {
	...
	late final TranslationsSettingsGeneralEditorRowEn row = TranslationsSettingsGeneralEditorRowEn.internal(_root);
}
...
class TranslationsSettingsShortcutsRowEn {
	...
	String get extract_text_from_screen_selection => 'Extract text from screen selection';

	/// en: 'Extract text from screen capture'
	String get extract_text_from_screen_capture => 'Extract text from screen capture';
...
class TranslationsSettingsShortcutsResetDialogEn {
	...
	String get message => 'Are you sure you want to reset all shortcuts to their default values?';
...
class TranslationsSettingsShortcutsGroupEn {
	...
	// Translations
	late final TranslationsSettingsShortcutsGroupGlobalEn global = TranslationsSettingsShortcutsGroupGlobalEn.internal(_root);
	late final TranslationsSettingsShortcutsGroupInAppEn in_app = TranslationsSettingsShortcutsGroupInAppEn.internal(_root);
}
...
class TranslationsSettingsServicesEditorEn {
	...
	late final TranslationsSettingsServicesEditorRowEn row = TranslationsSettingsServicesEditorRowEn.internal(_root);

	/// en: 'Leave blank to use the default prompt for this kind'
	String get prompt_placeholder => 'Leave blank to use the default prompt for this kind';

	/// en: '{} already has a {} service; this one is added alongside it as a second configuration.'
	String get variant_hint => '{} already has a {} service; this one is added alongside it as a second configuration.';

	/// en: '{} is a traditional endpoint — no model or prompt to tune. Its parameters live on the provider's detail page.'
	String get traditional_note => '{} is a traditional endpoint — no model or prompt to tune. Its parameters live on the provider\'s detail page.';
}
...
class TranslationsSettingsServicesDetailEn {
	...
	// Translations
	late final TranslationsSettingsServicesDetailRowEn row = TranslationsSettingsServicesDetailRowEn.internal(_root);
	late final TranslationsSettingsServicesDetailDeleteDialogEn delete_dialog = TranslationsSettingsServicesDetailDeleteDialogEn.internal(_root);

	/// en: 'Available variables: {{sourceLanguage}}, {{targetLanguage}}, {{text}}'
	String get prompt_variables => 'Available variables: {{sourceLanguage}}, {{targetLanguage}}, {{text}}';
}
...
class TranslationsSettingsProvidersSectionEn {
	...
	String get services_description => 'View available services from configured providers and switch between service types.';
}
...
class TranslationsSettingsProvidersItemEn {
	...
	String get empty => 'No providers configured. Add one to enable translation services.';
...
class TranslationsSettingsProvidersIntroEn {
	...
	String get warning => 'Connected providers may process the text or images you send. Only enable services you trust.';
}
...
class TranslationsSettingsProvidersEditorEn {
	...
	// Translations
	late final TranslationsSettingsProvidersEditorRowEn row = TranslationsSettingsProvidersEditorRowEn.internal(_root);
	late final TranslationsSettingsProvidersEditorPlaceholderEn placeholder = TranslationsSettingsProvidersEditorPlaceholderEn.internal(_root);
	late final TranslationsSettingsProvidersEditorTypePickerEn type_picker = TranslationsSettingsProvidersEditorTypePickerEn.internal(_root);
	late final TranslationsSettingsProvidersEditorTooltipEn tooltip = TranslationsSettingsProvidersEditorTooltipEn.internal(_root);
	late final TranslationsSettingsProvidersEditorStepEn step = TranslationsSettingsProvidersEditorStepEn.internal(_root);

	/// en: 'Add {}'
	String get add_title => 'Add {}';

	late final TranslationsSettingsProvidersEditorCapabilityNoteEn capability_note = TranslationsSettingsProvidersEditorCapabilityNoteEn.internal(_root);
	late final TranslationsSettingsProvidersEditorTestEn test = TranslationsSettingsProvidersEditorTestEn.internal(_root);
}
...
class TranslationsSettingsProvidersDetailEn {
	...
	// Translations
	late final TranslationsSettingsProvidersDetailTooltipEn tooltip = TranslationsSettingsProvidersDetailTooltipEn.internal(_root);
	late final TranslationsSettingsProvidersDetailRowEn row = TranslationsSettingsProvidersDetailRowEn.internal(_root);
	late final TranslationsSettingsProvidersDetailSectionEn section = TranslationsSettingsProvidersDetailSectionEn.internal(_root);
	late final TranslationsSettingsProvidersDetailModelsEn models = TranslationsSettingsProvidersDetailModelsEn.internal(_root);
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'app.tray.context_menu.dev_tools.open_data_directory' => 'Open Data Directory',
			...
			'mini_translator.limited_banner.permission.missing_screen_capture' => 'Grant Screen Recording permission to enable all features.',
			'mini_translator.limited_banner.permission.missing_accessibility' => 'Grant Accessibility permission to enable all features.',
			'mini_translator.limited_banner.instruction.app_settings_prefix' => 'Go to ',
			'mini_translator.limited_banner.instruction.follow_guide_prefix' => ', follow the guide, then click ',
			...
			'mini_translator.limited_banner.feedback.enabled' => 'Screen text extraction is enabled.',
			...
			'mini_translator.input.hint_translate_to' => ({required Object language}) => 'Type a word or text to translate into ${language}',
			'mini_translator.toolbar.tooltip.extract_text_from_screen_capture' => 'Capture screen area and recognize text',
			'mini_translator.toolbar.tooltip.extract_text_from_clipboard' => 'Read clipboard content',
			'mini_translator.toolbar.tooltip.pin' => 'Pin window',
			'mini_translator.toolbar.tooltip.more_actions' => 'More actions',
			'mini_translator.toolbar.menu.extract_from_screen_capture' => 'Capture from screen',
			...
			'mini_translator.language.manage_common_languages' => 'Manage Common Languages...',
			'mini_translator.language.manage_targets' => 'Manage Translation Targets...',
			'mini_translator.language.add_target' => 'Add Translation Target...',
			'mini_translator.message.please_enter_word_or_text' => 'No text entered or text not extracted',
			'mini_translator.message.capture_screen_area_canceled' => 'Capture screen area has been canceled',
			...
			'mini_translator.message.ocr_recognition_failed' => 'Text recognition failed',
			'mini_translator.result.translating' => 'Translating…',
			'mini_translator.result.stale_requery' => 'Source changed · ⏎ retranslate',
			'mini_translator.result.compare_services' => ({required Object count}) => 'Compare ${count} services',
			...
			'mini_translator.result.no_result_note' => 'Your text is kept; retrying will not duplicate history.',
			...
			'workbench.glossary_page.priority_note' => 'Glossary terms outrank any service output',
			...
			'workbench.translation.loading_services' => 'Loading translation services…',
			'workbench.translation.no_services' => 'Configure a translation service in Settings first',
			...
			'workbench.translation.other_services_disabled' => 'Other services are disabled',
			...
			'settings.general.section.translation_behaviour' => 'Translation Behaviour',
			'settings.general.row.launch_at_login' => 'Launch when you log in',
			'settings.general.row.show_in_menu_bar' => 'Show in menu bar',
			'settings.general.row.screen_capture_access' => 'Grant screen recording access',
			'settings.general.row.screen_selection_access' => 'Grant accessibility access',
			'settings.general.row.default_ocr_service' => 'Default text recognition service',
			'settings.general.row.auto_copy_detected_text' => 'Auto copy detected text',
			'settings.general.row.default_directory_service' => 'Default directory service',
			'settings.general.row.default_translation_service' => 'Default translation service',
			'settings.general.row.translation_target_hint' => 'Configure language pairs used by the translator.',
			'settings.general.row.common_languages' => 'Common Languages',
			'settings.general.row.common_languages_description' => 'Shown at the top of language pickers.',
			'settings.general.row.common_languages_hint' => 'Select your common languages:',
			'settings.general.row.common_languages_sort' => 'Sort by Code',
			'settings.general.row.double_click_copy_result' => 'Double click to copy translation result',
			'settings.general.row.common_languages_reset' => 'Reset to Defaults',
			'settings.general.row.common_languages_reset_help' => 'Reset to the default set of common languages',
			...
			'settings.general.row.submit_with_meta_enter_mac' => 'Submit with ⌘ + Enter',
			'settings.general.row.screen_capture_access_hint' => 'Capturing text from the screen needs to read screen contents.',
			'settings.general.row.screen_selection_access_hint' => 'Capturing selected text needs to read selections in other apps.',
			...
			'settings.general.button.manage_targets' => 'Manage Translation Targets...',
			'settings.general.button.manage_languages' => 'Manage Common Languages...',
			'settings.general.button.grant' => 'Grant',
			'settings.general.option.none' => 'None',
			'settings.general.option.no_services_available' => 'No services available',
			...
			'settings.appearance.footer' => 'Changes apply to the whole window immediately.',
			...
			'settings.shortcuts.row.extract_text_from_screen_selection' => 'Extract text from screen selection',
			'settings.shortcuts.row.extract_text_from_screen_capture' => 'Extract text from screen capture',
			'settings.shortcuts.row.extract_text_from_clipboard' => 'Extract text from clipboard',
			...
			'settings.shortcuts.group.in_app.description' => 'Only apply inside this app’s own text fields.',
			'settings.shortcuts.reset' => 'Restore Defaults...',
			'settings.advanced.title' => 'Advanced',
			'settings.advanced.api_server' => 'Local API server',
			'settings.advanced.api_server_description' => 'Expose the translation API on 127.0.0.1 for local integrations.',
			...
			'settings.services.editor.subtitle' => 'Add one more service to a configured provider',
			'settings.services.editor.row.model' => 'Model',
			'settings.services.editor.row.system_prompt' => 'System Prompt',
			'settings.services.editor.prompt_placeholder' => 'Leave blank to use the default prompt for this kind',
			...
			'settings.services.detail.delete_dialog.message' => 'This service will be removed from the provider.',
			...
			'settings.providers.item.empty' => 'No providers configured. Add one to enable translation services.',
			...
			'settings.providers.intro.body' => 'Manage the service providers used by the app.',
			...
			'settings.providers.editor.type_picker.prompt' => 'Select the type of provider you would like to add:',
			'settings.providers.editor.type_picker.section_llm' => 'LLM',
			'settings.providers.editor.type_picker.section_traditional' => 'Traditional',
			...
			'settings.providers.editor.capability_note.translation' => 'Joins the translation candidates',
			'settings.providers.editor.capability_note.dictionary' => 'Provides dictionary definitions',
			'settings.providers.editor.capability_note.ocr' => 'Recognises text in images',
			'settings.providers.editor.test.run' => 'Test Connection',
			'settings.providers.editor.test.running' => 'Testing connection · {}s elapsed',
			'settings.providers.editor.test.passed_models' => 'Connection OK · {} models available',
			'settings.providers.editor.test.passed_service' => 'Connection OK · service available',
			'settings.providers.editor.test.passed_footer' => 'Connection test passed',
			...
			'settings.providers.detail.row.id_hint' => 'Cannot be changed after creation',
			...
			'settings.providers.detail.models.fetch_error' => 'Could not fetch models from provider API.',
			...
			'settings.providers.description.all' => 'Provides dictionary lookup and text translation',
			'settings.providers.description.dictionary' => 'Provides dictionary lookup and word definitions',
			'settings.providers.description.translation' => 'Provides text translation between languages',
			'settings.providers.description.fallback' => 'Provides translation services',
			'settings.providers.delete_dialog.title' => 'Delete "{}"?',
			'settings.providers.delete_dialog.message' => 'This action cannot be undone.',
