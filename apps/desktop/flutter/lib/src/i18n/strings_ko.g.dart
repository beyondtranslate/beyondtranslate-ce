...
class _TranslationsMiniTranslatorResultKo extends TranslationsMiniTranslatorResultEn {
	...
	@override String compare_services({required Object count}) => '서비스 ${count}개 비교';
	@override String get collapse_compare => '비교 접기';
	@override String get set_preferred => '기본으로 설정';
	@override String get retry => '다시 시도';
	@override String get no_result => '어떤 서비스도 결과를 반환하지 않았습니다. 네트워크를 확인하거나 다른 서비스을 사용해 보세요.';
...
class _TranslationsWorkbenchSubtitleKo extends TranslationsWorkbenchSubtitleEn {
	...
	// Translations
	@override String get translate => '워크벤치 · 서비스 비교';
...
class _TranslationsWorkbenchGlossaryPageKo extends TranslationsWorkbenchGlossaryPageEn {
	...
	@override String get priority_note => '용어집은 어떤 서비스 출력보다 우선합니다';
	...
	@override String get empty_description => '용어집은 어떤 서비스 출력보다 우선합니다. 하나씩 추가하거나 CSV를 끌어다 놓아 병합하세요.';
	...
	@override String get no_books_description => '용어집은 선택한 번역어를 모든 서비스에서 일관되게 유지합니다. 먼저 하나 만들고 용어를 추가하세요.';
...
class _TranslationsWorkbenchTranslationKo extends TranslationsWorkbenchTranslationEn {
	...
	@override String get service_compare => '서비스 비교';
	...
	@override String get other_services => '다른 서비스';
	...
	@override String get other_services_disabled => '다른 서비스이 비활성화됨';
...
class _TranslationsSettingsAppearanceKo extends TranslationsSettingsAppearanceEn {
	...
	@override String get footer => '변경 사항은 창 전체에 즉시 적용됩니다.';
}
...
class _TranslationsSettingsShortcutsKo extends TranslationsSettingsShortcutsEn {
	...
	@override late final _TranslationsSettingsShortcutsGroupKo group = _TranslationsSettingsShortcutsGroupKo._(_root);
	@override String get reset => '기본값 복원...';
}
...
class _TranslationsSettingsServicesKo extends TranslationsSettingsServicesEn {
	...
	@override String get make_default => '기본으로 설정';
	@override late final _TranslationsSettingsServicesItemKo item = _TranslationsSettingsServicesItemKo._(_root);
}
...
class _TranslationsSettingsGeneralSectionKo extends TranslationsSettingsGeneralSectionEn {
	...
	// Translations
	@override String get permissions => '시스템 권한';
	...
	@override String get startup => '시작 및 통합';
	@override String get ocr_behaviour => '가져오기 동작';
	@override String get translation_behaviour => '번역 동작';
}
...
class _TranslationsSettingsGeneralRowKo extends TranslationsSettingsGeneralRowEn {
	...
	@override String get screen_capture_access_hint => '화면에서 텍스트를 가져오려면 화면 내용을 읽어야 합니다.';
	@override String get screen_selection_access_hint => '선택한 텍스트를 가져오려면 다른 앱의 선택 항목을 읽어야 합니다.';
	@override String get no_translation_targets => '번역 대상이 없습니다. 기본 번역 언어를 정하려면 하나 추가하세요.';
}
...
class _TranslationsSettingsShortcutsSectionKo extends TranslationsSettingsShortcutsSectionEn {
	...
	@override String get submit_mode => '전송 방식';
}
...
class _TranslationsSettingsShortcutsGroupKo extends TranslationsSettingsShortcutsGroupEn {
	_TranslationsSettingsShortcutsGroupKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override late final _TranslationsSettingsShortcutsGroupGlobalKo global = _TranslationsSettingsShortcutsGroupGlobalKo._(_root);
	@override late final _TranslationsSettingsShortcutsGroupInAppKo in_app = _TranslationsSettingsShortcutsGroupInAppKo._(_root);
}
...
class _TranslationsSettingsServicesEditorKo extends TranslationsSettingsServicesEditorEn {
	...
	// Translations
	@override String get title => '서비스 추가';
	@override String get subtitle => '구성된 제공자에 서비스를 하나 더 추가합니다';
	@override late final _TranslationsSettingsServicesEditorRowKo row = _TranslationsSettingsServicesEditorRowKo._(_root);
	@override String get prompt_placeholder => '비워 두면 이 유형의 기본 프롬프트를 사용합니다';
	@override String get variant_hint => '{}에 이미 {} 서비스가 있습니다. 이 서비스는 별도의 구성으로 나란히 추가됩니다.';
	@override String get traditional_note => '{}은(는) 전통적인 인터페이스라 조정할 모델이나 프롬프트가 없습니다. 매개변수는 제공자 상세 페이지에서 설정합니다.';
}
...
class _TranslationsSettingsServicesItemKo extends TranslationsSettingsServicesItemEn {
	_TranslationsSettingsServicesItemKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get none_of_kind => '사용할 수 있는 {} 서비스가 아직 없습니다.';
}
...
class _TranslationsSettingsProvidersEditorKo extends TranslationsSettingsProvidersEditorEn {
	...
	@override late final _TranslationsSettingsProvidersEditorStepKo step = _TranslationsSettingsProvidersEditorStepKo._(_root);
	@override String get add_title => '{} 추가';
	@override late final _TranslationsSettingsProvidersEditorCapabilityNoteKo capability_note = _TranslationsSettingsProvidersEditorCapabilityNoteKo._(_root);
	@override late final _TranslationsSettingsProvidersEditorTestKo test = _TranslationsSettingsProvidersEditorTestKo._(_root);
}
...
class _TranslationsSettingsProvidersDetailKo extends TranslationsSettingsProvidersDetailEn {
	...
	@override late final _TranslationsSettingsProvidersDetailRowKo row = _TranslationsSettingsProvidersDetailRowKo._(_root);
...
class _TranslationsSettingsShortcutsGroupGlobalKo extends TranslationsSettingsShortcutsGroupGlobalEn {
	_TranslationsSettingsShortcutsGroupGlobalKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get title => '전역 단축키';
	@override String get description => '모든 앱에서 작동합니다.';
}

// Path: settings.shortcuts.group.in_app
class _TranslationsSettingsShortcutsGroupInAppKo extends TranslationsSettingsShortcutsGroupInAppEn {
	_TranslationsSettingsShortcutsGroupInAppKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get title => '앱 내 키';
	@override String get description => '이 앱의 입력란에서만 적용됩니다.';
}

// Path: settings.services.editor.row
class _TranslationsSettingsServicesEditorRowKo extends TranslationsSettingsServicesEditorRowEn {
	_TranslationsSettingsServicesEditorRowKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get model => '모델';
	@override String get system_prompt => '시스템 프롬프트';
}
...
class _TranslationsSettingsProvidersEditorRowKo extends TranslationsSettingsProvidersEditorRowEn {
	...
	@override String get type => '제공자 유형';
	@override String get default_model => '기본 모델';
}
...
class _TranslationsSettingsProvidersEditorStepKo extends TranslationsSettingsProvidersEditorStepEn {
	_TranslationsSettingsProvidersEditorStepKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get next => '계속';
	@override String get back => '이전';
}

// Path: settings.providers.editor.capability_note
class _TranslationsSettingsProvidersEditorCapabilityNoteKo extends TranslationsSettingsProvidersEditorCapabilityNoteEn {
	_TranslationsSettingsProvidersEditorCapabilityNoteKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get translation => '번역 후보에 참여합니다';
	@override String get dictionary => '사전 뜻풀이를 제공합니다';
	@override String get ocr => '이미지 속 문자를 인식합니다';
}

// Path: settings.providers.editor.test
class _TranslationsSettingsProvidersEditorTestKo extends TranslationsSettingsProvidersEditorTestEn {
	_TranslationsSettingsProvidersEditorTestKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get run => '연결 테스트';
	@override String get running => '연결 테스트 중 · {}s 경과';
	@override String get passed_models => '연결 정상 · 모델 {}개 사용 가능';
	@override String get passed_service => '연결 정상 · 서비스 사용 가능';
	@override String get passed_footer => '연결 테스트를 통과했습니다';
	@override String get retest => '다시 테스트';
	@override String get tips_title => '이렇게 해보세요';
	@override String get tips_llm => '· 키가 선택한 제공자 유형과 맞는지 확인하세요\n· Base URL에 /v1이 필요한지 확인하세요\n· 제공자 콘솔에서 해당 모델이 활성화되어 있는지 확인하세요';
	@override String get tips_traditional => '· 자격 증명이 선택한 제공자 유형과 맞는지 확인하세요\n· 제공자 콘솔에서 서비스가 활성화되어 있는지 확인하세요';
	@override String get failed_suffix => '검증 실패';
	@override String get passed_suffix => '검증됨';
}
...
class _TranslationsSettingsProvidersDetailRowKo extends TranslationsSettingsProvidersDetailRowEn {
	_TranslationsSettingsProvidersDetailRowKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get id_hint => '생성 후에는 변경할 수 없습니다';
}
...
class _TranslationsSettingsProvidersDetailModelsKo extends TranslationsSettingsProvidersDetailModelsEn {
	...
	@override String get refresh => '목록 새로 고침';
	@override String get default_badge => '기본값';
	@override String get set_default => '기본값으로 설정';
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'mini_translator.result.compare_services' => ({required Object count}) => '서비스 ${count}개 비교',
			...
			'mini_translator.result.no_result' => '어떤 서비스도 결과를 반환하지 않았습니다. 네트워크를 확인하거나 다른 서비스을 사용해 보세요.',
			...
			'workbench.glossary_page.empty_description' => '용어집은 어떤 서비스 출력보다 우선합니다. 하나씩 추가하거나 CSV를 끌어다 놓아 병합하세요.',
			...
			'workbench.glossary_page.no_books_description' => '용어집은 선택한 번역어를 모든 서비스에서 일관되게 유지합니다. 먼저 하나 만들고 용어를 추가하세요.',
			...
			'settings.general.row.screen_capture_access_hint' => '화면에서 텍스트를 가져오려면 화면 내용을 읽어야 합니다.',
			'settings.general.row.screen_selection_access_hint' => '선택한 텍스트를 가져오려면 다른 앱의 선택 항목을 읽어야 합니다.',
			'settings.general.row.no_translation_targets' => '번역 대상이 없습니다. 기본 번역 언어를 정하려면 하나 추가하세요.',
			...
			'settings.services.editor.prompt_placeholder' => '비워 두면 이 유형의 기본 프롬프트를 사용합니다',
			'settings.services.editor.variant_hint' => '{}에 이미 {} 서비스가 있습니다. 이 서비스는 별도의 구성으로 나란히 추가됩니다.',
			'settings.services.editor.traditional_note' => '{}은(는) 전통적인 인터페이스라 조정할 모델이나 프롬프트가 없습니다. 매개변수는 제공자 상세 페이지에서 설정합니다.',
			...
			'settings.providers.editor.test.tips_traditional' => '· 자격 증명이 선택한 제공자 유형과 맞는지 확인하세요\n· 제공자 콘솔에서 서비스가 활성화되어 있는지 확인하세요',
