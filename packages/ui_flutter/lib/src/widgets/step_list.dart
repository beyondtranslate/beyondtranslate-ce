...
class Step extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      StepStatus.done => Container(
          ...
          child: Text(
            ...
            style: tokens.typography
                .sansStyle(fontSize: 11, height: 1, color: colors.success),
          ),
        ),
    ...
    final labelStyle = switch (status) {
      ...
      StepStatus.done =>
        tokens.typography.sansStyle(fontSize: 12, color: colors.fgTertiary),
      StepStatus.idle =>
        tokens.typography.sansStyle(fontSize: 12, color: colors.fgSubtle),
    };
